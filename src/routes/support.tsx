...
export const Route = createFileRoute("/support")({
  head: () => ({
    meta: [
      { title: "Support — Digie" },
      { name: "description", content: "Digie help centre: warranty, downloads, troubleshooting and customer care across 400+ service centres." },
    ],
  }),
...
const cards = [
  {
    ...
    description: "Register and track your warranty claims in minutes. Our team processes requests quickly so you're never left waiting.",
    image: warrantyImg,
  },
  {
    icon: FileText,
    title: "Troubleshooting",
    description: "Step-by-step guides to resolve common issues quickly. Find fixes for your product without ever needing to call us.",
    image: troubleshootingImg,
  },
  {
    icon: MessageCircle,
    title: "Live Support",
    description: "Chat or call +91-84477 44522, seven days a week. Our experts are always ready to help you get back on track.",
    ...
    <>
      ...
      <section className="container-px mx-auto max-w-3xl pb-14">
        ...
        <Accordion type="single" collapsible className="mt-8">
          {faqs.map((f, i) => (
            <AccordionItem key={i} value={`s-${i}`} className="mb-3 rounded-2xl border border-border bg-card px-5 shadow-soft">
