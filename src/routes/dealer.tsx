  ...
  head: () => ({
    meta: [
      { title: "Dealer Network — Digie" },
      {
        name: "description",
        content:
          "Become a Digie dealer. Premium margins, marketing support and a trusted brand across India.",
      },
    ],
  }),
...
const benefits = [
  {
    ...
    description: "Industry-leading margins with volume incentives and seasonal bonuses.",
  },
  {
    icon: Megaphone,
    title: "Marketing Support",
    description: "Co-branded campaigns, in-store assets and digital lead generation.",
  },
  {
    icon: Handshake,
    title: "Dedicated Manager",
    description: "A regional partner manager committed to your store's growth.",
  },
];
...
function DealerPage() {
  ...
  const handle = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setSubmitting(false);
      toast.success("Application received! Our team will reach out within 3 working days.");
    }, 800);
  };
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <ul className="mt-6 space-y-3">
              {[
                "Registered retail space (min. 300 sq ft)",
            ...
            <div className="mt-8 flex items-center gap-3 rounded-3xl border border-border bg-secondary/40 p-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Active in 28 states · expanding to 500 new towns by 2026.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <Input required placeholder="+91" className="rounded-xl" />
                </div>
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <Label className="mb-1.5 block">City</Label>
                  <Input required placeholder="City" className="rounded-xl" />
                </div>
                <div>
                  <Label className="mb-1.5 block">Store name</Label>
                  <Input placeholder="Store" className="rounded-xl" />
                </div>
              </div>
