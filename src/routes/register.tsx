        ...
        <form
          onSubmit={(e) => {
            ...
            if (!otp) {
              ...
              toast.success("Account verified! Welcome to Digie.");
            }
          }}
            ...
            <div className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <Input required placeholder="First" className="rounded-xl" />
                </div>
                <div>
                  <Label className="mb-1.5 block">Last name</Label>
                  <Input required placeholder="Last" className="rounded-xl" />
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <Input required type="password" placeholder="••••••••" className="rounded-xl" />
              </div>
              <label className="flex items-center gap-2 text-sm">
                <Checkbox required /> I agree to the Terms & Privacy Policy
              </label>
              ...
              <div className="flex justify-center gap-2">
                {Array.from({ length: 6 }).map((_, i) => (
                  <Input
                    key={i}
                    maxLength={1}
                    className="h-12 w-12 rounded-xl text-center text-lg"
                  />
                ))}
              </div>
              <Button variant="accent" size="lg" className="w-full">
